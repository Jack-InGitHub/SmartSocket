...
* @{
*/
#define PRODUCT_KEY "281d13bb64c641c293c91397430d2fb7"
/**@} */
/**@name Product Secret
* @{
*/
#define PRODUCT_SECRET "39f33436bf1c46b7a31716e4af2fdf79"
...
* @{
*/
#define Socket1_BYTEOFFSET                    0
#define Socket1_BITOFFSET                     0
#define Socket1_LEN                           1
#define Socket2_BYTEOFFSET                    0
#define Socket2_BITOFFSET                     1
#define Socket2_LEN                           1

#define OnDay_1_RATIO                         1
#define OnDay_1_ADDITION                      0
#define OnDay_1_MIN                           0
#define OnDay_1_MAX                           30
#define OnHour_1_RATIO                         1
#define OnHour_1_ADDITION                      0
#define OnHour_1_MIN                           0
#define OnHour_1_MAX                           23
#define OnMinute_1_RATIO                         1
#define OnMinute_1_ADDITION                      0
#define OnMinute_1_MIN                           0
#define OnMinute_1_MAX                           59
#define OffDay_1_RATIO                         1
#define OffDay_1_ADDITION                      0
#define OffDay_1_MIN                           0
#define OffDay_1_MAX                           30
#define OffHour_1_RATIO                         1
#define OffHour_1_ADDITION                      0
#define OffHour_1_MIN                           0
#define OffHour_1_MAX                           23
#define OffMinute_1_RATIO                         1
#define OffMinute_1_ADDITION                      0
#define OffMinute_1_MIN                           0
#define OffMinute_1_MAX                           59
#define Current_RATIO                         0.001
...
#define Temperature_ADDITION                      -25
#define Temperature_MIN                           0
#define Temperature_MAX                           1500
#define RH_RATIO                         0.1
#define RH_ADDITION                      0
#define RH_MIN                           0
#define RH_MAX                           1000
/**@} */
...
typedef struct {
    bool valueSocket1;
    bool valueSocket2;
    uint32_t valueOnDay_1;
    uint32_t valueOnHour_1;
    uint32_t valueOnMinute_1;
    uint32_t valueOffDay_1;
    uint32_t valueOffHour_1;
    uint32_t valueOffMinute_1;
    float valueCurrent;
    float valueVoltage;
...
typedef struct {
    uint8_t flagSocket1:1;
    uint8_t flagSocket2:1;
    uint8_t flagOnDay_1:1;
    uint8_t flagOnHour_1:1;
    uint8_t flagOnMinute_1:1;
    uint8_t flagOffDay_1:1;
    uint8_t flagOffHour_1:1;
    uint8_t flagOffMinute_1:1;
} attrFlags_t;
...
typedef struct {
    ...
    uint8_t valueOnDay_1;
    uint8_t valueOnHour_1;
    uint8_t valueOnMinute_1;
    uint8_t valueOffDay_1;
    uint8_t valueOffHour_1;
    uint8_t valueOffMinute_1;
} attrVals_t;
